...
9.  Run `./clear_tmp` to clear the tmp files. **ATTENTION**: If you run this command, you will not be able to create the correct protect song. Please make sure to create all protect songs before running it.
